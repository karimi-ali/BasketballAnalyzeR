...
BasketballAnalyzeR::densityplot(data=data.team, shot.type="2P",
...
BasketballAnalyzeR::densityplot(data=data.opp, shot.type="2P",
                                var="periodTime", best.scorer=TRUE)
BasketballAnalyzeR::densityplot(data=data.opp, shot.type="2P",
                                var="totalTime",best.scorer=TRUE)
BasketballAnalyzeR::densityplot(data=data.opp, shot.type="2P",
...
BasketballAnalyzeR::densityplot(data=KD, shot.type="field",
                                var="playlength")
BasketballAnalyzeR::densityplot(data=KD, shot.type="field",
                                var="shot_distance")
BasketballAnalyzeR::densityplot(data=SC, shot.type="field",
                                var="playlength")
BasketballAnalyzeR::densityplot(data=SC, shot.type="field",
                                var="shot_distance")
```
```{r}
# Creating shot charts for different players
# Adjust coordinates
